...
?>
	...
	<form method="post">
		<fieldset>
			...
			<input type="text" name="username" id="username" value="<?php echo !empty($_REQUEST["username"]) ? $_REQUEST["username"] : ''; ?>">
			<font color="red"><?php echo $errors["username"]; ?></font>
			<br>
			<label for="password">Password</label>
			<input type="password" name="password" id="password">
			<font color="red"><?php echo !empty($errors["password"])?$errors["password"]:''; ?></font>
			<br>
